...
export const metadata: Metadata = {
  ...
  description:
    "Boundary First Labs outer-architecture acceptance criteria, structural invariants, review status, and human validation boundaries.",
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex items-end justify-between gap-6">
            <div>
              ...
              <h2 className="mt-3 font-serif text-4xl font-semibold">Implemented, but still awaiting human review.</h2>
            </div>
