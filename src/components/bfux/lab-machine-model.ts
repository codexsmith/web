...
export const labMachineNodes: LabMachineNode[] = [
  ...
  { id:"method", label:"Method", question:"HOW", boundary:"Where the Lab's method, mechanics, and processes are defined and refined.", kind:"attachment", tone:"green", state:"DEFINED", meta:["type · attachment","interface · standard"], area:"method" },
  { id:"pipeline", label:"Pipeline", question:"FLOW", boundary:"The workstream that moves ideas from inquiry to vetted, maintainable artifacts.", kind:"pipeline", tone:"green", state:"FLOWING", meta:["queue · active","quality · gated"], area:"pipeline" },
  { id:"research", label:"Research", question:"ENGINE", boundary:"Where claims, methods, mechanisms, and formal structure are developed and tested.", kind:"core", tone:"violet", state:"ACTIVE", meta:["methods · formal","evidence · required"], area:"research" },
  { id:"about", label:"About", question:"WHY", boundary:"Where institutional identity, method, provenance, and contact remain inspectable.", kind:"identity", tone:"amber", state:"STABLE", meta:["identity · verified","provenance · traceable"], area:"about" },
  ...
  { id:"governance", label:"Governance", question:"AUTHORITY", boundary:"Where authority, stewardship, policies, and repair mechanisms are documented.", kind:"authority", tone:"slate", state:"ENFORCED", meta:["authority · distributed","policies · versioned"], area:"governance" },
  { id:"timeline", label:"Timeline", question:"WHEN", boundary:"Where the Lab's development is recorded as an inspectable sequence of events.", kind:"record", tone:"slate", state:"RECORDING", meta:["order · chronological","granularity · variable"], area:"timeline" },
