      ...
      <div id="entrances">
        ...
        <section className="border-b border-border px-5 py-12 sm:px-8 sm:py-16">
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(19rem,0.72fr)] lg:items-end">
              ...
              <div>
                <p className="text-base font-medium leading-8 text-foreground/70">
                ...
                <p className="mt-3 font-mono text-[10px] uppercase leading-5 tracking-[0.12em] text-muted-foreground">
                  {ENTRANCE_INVARIANT}
                </p>
              </div>
            </div>
              ...
              {ENTRANCE_ROUTES.map((route, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-10 font-mono text-[10px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                      {route.label}
                    </p>
                    ...
                    <p className="mt-7 border-t border-border pt-4 text-sm font-medium leading-6 text-foreground/80">
                      {route.promise}
                    </p>
                    <span className="mt-3 block font-mono text-[10px] uppercase leading-5 tracking-[0.11em] text-muted-foreground">
                      {route.effort}
                    </span>
            ...
            <div className="mt-5 flex flex-wrap items-center gap-x-5 gap-y-2 text-sm">
              <Link className="inline-flex min-h-11 items-center gap-2 hover:underline" href="/publications/civilizational-mechanics">
                <LibraryBig className="h-4 w-4 text-muted-foreground" aria-hidden="true" />
              ...
              <div className="mt-6 grid gap-px overflow-hidden border border-border bg-border sm:grid-cols-2 lg:grid-cols-4">
                {recognitionRoutes.map((item) => (
                  <Link className="group bg-background p-5 transition-colors hover:bg-card" href={item.href} key={item.statement}>
                    ...
                    <span className="mt-6 inline-flex items-center font-mono text-[9px] font-semibold uppercase tracking-[0.12em] text-muted-foreground group-hover:text-foreground">
            ...
            <div className="grid gap-9 lg:grid-cols-[minmax(0,0.9fr)_minmax(25rem,1.1fr)] lg:items-stretch">
              <div className="flex flex-col justify-between">
                <div>
                  ...
                  <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-foreground/72 sm:text-lg">
            ...
            <div className="mt-10 grid gap-px overflow-hidden border border-border bg-border md:grid-cols-3">
              {missionScales.map((scale, index) => (
                <article className="bg-card p-5 sm:p-6" key={firstText(scale.id)}>
                  ...
                  <p className="mt-3 text-sm font-medium leading-7 text-foreground/72">
        ...
        >
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-end">
            ...
            <div>
              <blockquote className="border-l-2 border-accent pl-5 text-xl font-medium leading-8 text-primary-foreground/90 sm:text-2xl sm:leading-9">
