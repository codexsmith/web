# Workstream 28 — Representational Laboratory Suite
...
Workstream 21 remains the owner of the broader **Scientific Visualization Sandboxes** program, especially physics and Fourier / spectral instruments. Workstream 28 owns the **Representational Mechanics public laboratory suite** defined by the new lab packet.
...
Workstream 26 remains the public essay/publication surface for the Fallacies of Distributed Reality. Workstream 28 turns the same underlying boundary-consequence structure into an executable experiment.
...
Workstream 28 is ready to call `phase-one complete` when:
